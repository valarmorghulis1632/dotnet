...
describe('EditNoteViewComponent', () => {
  ...
  beforeEach(() => {
    ...
    spyRouteBack = spyOn(routerService, 'routeBack').and.callFake(() => {});
  ...
  it('should handle 404 error on edit note', fakeAsync(() => {
    ...
    spyEditNote = spyOn(notesService, 'editNote').and.returnValue(observableThrowError(errorResponse404));
  ...
  it('should handle edit note', fakeAsync(() => {
    ...
    inputBox = fixture.debugElement.nativeElement.querySelector('input');
    textArea = fixture.debugElement.nativeElement.querySelector('textarea');
    spyEditNote = spyOn(notesService, 'editNote').and.returnValue(observableOf(positiveResponse));
    fixture.detectChanges();
    tick();
